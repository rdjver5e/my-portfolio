/* ─── Resume content ───────────────────────────────────────────────
   Matches the reference image 1:1. Edit with care.
------------------------------------------------------------------- */
...
export const resume = {
  ...
  experiences: [
    ...
    },
    {
      ...
      points: [
        ...
        'Collaborated with clients and developers to deliver projects on time, aligned with brand and business objectives.',
      ],
    },
  ],
  ...
  projects: [
    ...
    },
    {
      ...
      points: [
        'Designed and prototyped a healthcare appointment booking system with user-friendly scheduling flow. Focused on ease of navigation and responsive UI for patients and doctors.',
      ],
    },
    {
      name: 'OrbitDynamix',
    ...
    },
    {
      ...
      tag: 'Ecommerce Website',
      points: [
        'Built a modern e-commerce experience with optimized product discovery and responsive UI; focused on performance and cross-browser consistency.',
      ],
    },
    {
      name: 'Aeon Commercial Brokers',
      tag: 'Commercial Website',
      points: [
        'Designed and developed a commercial brokerage platform with clear information architecture and lead-focused, responsive layouts.',
      ],
    },
    {
      name: 'Finiacq',
    ...
    },
    {
      ...
      points: [
        'Designed and developed a real estate platform with property listings, search and responsive UI; focused on information clarity and cross-browser performance.',
      ],
    },
  ],
